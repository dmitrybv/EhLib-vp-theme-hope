...
<p>Use the sub-properties of <code v-pre>TDBGridEh.FooterParams</code> property to Customize the footer of the grid:</p>
...
<p><code v-pre>ExternalRecalc: Boolean</code></p>
...
<p><code v-pre>fvtNon</code>, <code v-pre>fvtSum</code>, <code v-pre>fvtAvg</code>, <code v-pre>fvtCount</code>, <code v-pre>fvtFieldValue</code>, <code v-pre>fvtStaticText</code> , <code v-pre>fvtMin</code>, <code v-pre>fvtMax</code></p>
</dd>
<br/>

...
<p><code v-pre>FieldNames</code> parameter specifies the name of the field or list of fields separated by a &quot;;&quot;. In case if FieldNames contains a list of fields, the return value will contain an array of values.</p>

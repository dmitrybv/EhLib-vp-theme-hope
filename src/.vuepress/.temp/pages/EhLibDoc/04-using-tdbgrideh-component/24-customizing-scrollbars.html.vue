...
The property is available only for horizontal stripes. The property specifies the parameters of the additional panel that is displayed in the left part of the band. A detailed description, see the next section.</p>
<p>To customize scollbars you need to use subprtoperties of HorzScrollBar and VertScrollBar properties.
...
sbAutoShowEh		Shows or hides scrollbar automatically depending on visible area of grid.</p>
<p>If DBGridEh is connected to DataSet of TMemTableEh type then on vertical scrolling grid doesn’t change position of active record.</p>
</div></template>
